...
import pacman.entries.pacman.MCTSController;
...
{	
	...
	public static void main(String[] args)
	{
		...
		exec.runGame(new MCTSController(), new Legacy2TheReckoning(), visual,delay);
		//exec.runGameTimed(new MCTSController(), new Legacy2TheReckoning(),visual);
		//exec.runExperiment(new MCTSController(), new Legacy2TheReckoning(),numTrials);
	}
    ...
    public void runExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
		...
		System.out.println("Average Score is: "+avgScore/trials);
    }
